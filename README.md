...
Обновление 0.28.0 — Master Polish & Tactical Depth: общие вкладки соперника,
пакетное подтверждение совпавших матчей, быстрый выбор карты и управление раундами.
В командном стратбуке и шпаргалке появились темп контакта, направления перед установкой
на Mirage и ранние позиции AWP. Правила и ограничения: [STAGE_9_14.md](STAGE_9_14.md).
