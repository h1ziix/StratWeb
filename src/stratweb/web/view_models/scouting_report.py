...
def _recommendation_text(
    ...
    common = {
        "interpretation": (
            "Это повторяющийся исторический сигнал, а не доказательство "
            "намерения или причины."
        ),
        "response": (
        ...
        "avoid": (
            "Не считайте тенденцию гарантированным действием "
            "и не переоценивайте небольшую выборку."
        ),
    }
    return common[kind]
